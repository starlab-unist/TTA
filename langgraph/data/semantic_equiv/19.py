...
# variable name: value_map -> numeral_to_digit
# used list comprehension for numeral_list with explicit filtering
# separated sorting and joining into distinct steps for clarity