...
# replaced the nested for loop with a while loop using an iterator
# added a try-except block to handle the StopIteration exception
# maintained the sorting and conversion to list at the end