...
# nested function name: isPrime -> check_prime
# variable name: maxx -> largest_prime, i -> index
# replaced the while loop condition with a more descriptive variable
# used a more descriptive variable name for the sum of digits: digit_sum