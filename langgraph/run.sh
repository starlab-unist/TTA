...
python generate-equiv.py \
    -s /workspace/vtw/data/equiv

echo "RUNNING TO GENERATE THE PYTHON TEST CASES..."
python generate-test.py \
    -td /workspace/vtw/data/equiv \
    -od /workspace/vtw/data/test-py

echo "TRANSLATING THE SOURCE PYTHON CODE WITH QWEN-32B MODEL..."
python translate.py \
    -i /workspace/vtw/data/humaneval-python.jsonl \
    -o /workspace/vtw/result/qwen/32b-py2js \
    -m Qwen/Qwen2.5-Coder-32B-Instruct

echo "TRANSLATING THE SEMANTIC EQUIVALENT CODE WITH QWEN-32B MODEL..."
python translate.py \
    -i /workspace/vtw/data/equiv \
    -o /workspace/vtw/result/qwen/32b-eq2js \
    -m Qwen/Qwen2.5-Coder-32B-Instruct

echo "ANALYZING THE TRANSLATED CODES BY QWEN-32B MODEL..."
python generate-test-js.py \
    -sd /workspace/vtw/result/qwen/32b-py2js \
    -td /workspace/vtw/result/qwen/32b-eq2js \
    -tcd /workspace/vtw/data/test-py \
    -od /workspace/vtw/result/qwen/32b-test-js

echo "TRANSLATING THE SOURCE PYTHON CODE WITH QWEN-14B MODEL..."
python translate.py \
    -i /workspace/vtw/data/humaneval-python.jsonl \
    -o /workspace/vtw/result/qwen/14b-py2js \
    -m Qwen/Qwen2.5-Coder-14B-Instruct

echo "TRANSLATING THE SEMANTIC EQUIVALENT CODE WITH QWEN-14B MODEL..."
python translate.py \
    -i /workspace/vtw/data/equiv \
    -o /workspace/vtw/result/qwen/14b-eq2js \
    -m Qwen/Qwen2.5-Coder-14B-Instruct

echo "ANALYZING THE TRANSLATED CODES BY QWEN-14B MODEL..."
python generate-test-js.py \
    -sd /workspace/vtw/result/qwen/14b-py2js \
    -td /workspace/vtw/result/qwen/14b-eq2js \
    -tcd /workspace/vtw/data/test-py \
    -od /workspace/vtw/result/qwen/14b-test-js

echo "TRANSLATING THE SOURCE PYTHON CODE WITH QWEN-7B MODEL..."
python translate.py \
    -i /workspace/vtw/data/humaneval-python.jsonl \
    -o /workspace/vtw/result/qwen/7b-py2js \
    -m Qwen/Qwen2.5-Coder-7B-Instruct

echo "TRANSLATING THE SEMANTIC EQUIVALENT CODE WITH QWEN-7B MODEL..."
python translate.py \
    -i /workspace/vtw/data/equiv \
    -o /workspace/vtw/result/qwen/7b-eq2js \
    -m Qwen/Qwen2.5-Coder-7B-Instruct

echo "ANALYZING THE TRANSLATED CODES BY QWEN-7B MODEL..."
python generate-test-js.py \
    -sd /workspace/vtw/result/qwen/7b-py2js \
    -td /workspace/vtw/result/qwen/7b-eq2js \
    -tcd /workspace/vtw/data/test-py \
    -od /workspace/vtw/result/qwen/7b-test-js

echo "TRANSLATING THE SOURCE PYTHON CODE WITH QWEN-3B MODEL..."
python translate.py \
    -i /workspace/vtw/data/humaneval-python.jsonl \
    -o /workspace/vtw/result/qwen/3b-py2js \
    -m Qwen/Qwen2.5-Coder-3B-Instruct

echo "TRANSLATING THE SEMANTIC EQUIVALENT CODE WITH QWEN-3B MODEL..."
python translate.py \
    -i /workspace/vtw/data/equiv \
    -o /workspace/vtw/result/qwen/3b-eq2js \
    -m Qwen/Qwen2.5-Coder-3B-Instruct

echo "ANALYZING THE TRANSLATED CODES BY QWEN-3B MODEL..."
python generate-test-js.py \
    -sd /workspace/vtw/result/qwen/3b-py2js \
    -td /workspace/vtw/result/qwen/3b-eq2js \
    -tcd /workspace/vtw/data/test-py \
    -od /workspace/vtw/result/qwen/3b-test-js
